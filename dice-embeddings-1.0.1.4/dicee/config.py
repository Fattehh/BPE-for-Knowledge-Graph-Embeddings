...
class Namespace(argparse.Namespace):
    def __init__(self, **kwargs):
        ...
        self.min_epochs: int|None = None
        "Minimum number of pass over the training data"
        ...
        self.bpe_truncation: str = "None"

        self.bpe_with_RNN = ""

        self.forced_truncation: int = 100

        self.multiple_bpe_encodings: int = 1

        self.multiple_bpe_loss: bool = False
