...
class Execute:
    ...
    def read_preprocess_index_serialize_data(self) -> None:
        ...
        self.args.ordered_bpe_relations = self.knowledge_graph.ordered_bpe_relations
        if self.args.multiple_bpe_loss:
            self.args.duplicate_additions = self.knowledge_graph.duplicate_additions
            self.args.duplicate_tokenizations = self.knowledge_graph.duplicate_tokenizations
            self.args.duplicate_lengths = self.knowledge_graph.duplicate_lengths

        self.args.length_dict = self.knowledge_graph.length_dict
